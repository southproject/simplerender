...
import PathProxy from '../../util/core/PathProxy';
import * as pathContain from '../../Render/contain/path';
...
Path.prototype = {
    ...
    // Overwrite attrKV
    attrKV: function (key, value, mode,stack=true,isUserText=false) {
        // FIXME
        if (key === 'shape') {
            ...
            Displayable.prototype.attrKV.call(this, key, value, mode,stack,isUserText);
        }
    },
